...
const Filter = ({ filters, otherClasses, containerClasses }: FilterProps) => {
  ...
  return (
    <div className={`relative ${containerClasses}`}>
      ...
      >
        <SelectTrigger
          className={`${otherClasses} body-regular light-border-2 background-light800_dark300 text-dark500_light700 border px-5 py-2.5 focus:ring-0 focus:ring-offset-0`}
        >
